...
TODO: Change these global language names to their ISO 636 versions

>>> from cltkv1.utils.example_texts import GREEK, HEBREW, LATIN, OLD_NORSE
>>> GREEK
...
# Matthaeus 5.16-18
GOTHIC = "swa liuhtjai liuhaþ izwar in andwairþja manne, ei gasaiƕaina izwara goda waurstwa jah hauhjaina attan izwarana þana in himinam. ni hugjaiþ ei qemjau gatairan witoþ aiþþau praufetuns; ni qam gatairan, ak usfulljan. amen auk qiþa izwis: und þatei usleiþiþ himins jah airþa, jota ains aiþþau ains striks ni usleiþiþ af witoda, unte allata wairþiþ."
...
# Lord's Prayer
OLD_CHURCH_SLAVONIC = """отьчє нашь·
ижє ѥси на нєбєсѣхъ:
